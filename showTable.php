...
<html>
<body>
<form id="time" method = "post" action="deltime.php"> 
<div id="content1">            
        <div class="timetable">
            <h2>나의 시간표</h2>
                ...
                <div class="timetable_main">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            {
                            	$sql = "select * from timetable where id='$id' and days='$days' order by startTime";
								...
								<td class="_week" colindex="<?=$days?>">
                                    ...
                                    ?>
									<div id="<?=$idnum?>" style="height: 50px; top:<?=$top1?>;">
										<?php 
                                            ...
                                            if($minute == 0)
                                            {
                                              ...
                                              echo $minute;
                                              echo " ] ";
                                              ?> <input type="checkbox" name="idnum[]" value="<?=$idnum?>"> <?php
                                        ?>
									</div> 
								<?php 
								$idnum++;
